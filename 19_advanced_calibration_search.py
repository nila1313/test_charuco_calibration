...
def collect_data(input_folder, min_corners, max_corners):
...
def robust_prune(frame_data, board, image_size, flags=0, max_rounds=15, remove_ratio=0.03):
    current = frame_data[:]
    ...
    for round_id in range(max_rounds):
        ...
        remove_count = max(1, int(len(current) * remove_ratio))
...
experiments = [
    {"name": "standard_8_18", "min_corners": 8, "max_corners": 18, "flags": 0},
    {"name": "standard_9_18", "min_corners": 9, "max_corners": 18, "flags": 0},
    {"name": "standard_9_20", "min_corners": 9, "max_corners": 20, "flags": 0},
    {"name": "standard_10_18", "min_corners": 10, "max_corners": 18, "flags": 0},
    {"name": "standard_10_20", "min_corners": 10, "max_corners": 20, "flags": 0},
]
...
if best_global is not None:
    ...
    np.savez(
        "charuco_calibration_result_19_advanced.npz",
        camera_matrix=best_global["K"],
        dist_coeffs=best_global["D"]
    )

    print("\nSaved charuco_calibration_result_19_advanced.npz")
else:
