...
image_paths = sorted(glob.glob("best_diverse_frames/*.jpg"))
...
os.makedirs("debug_all_good_calibration", exist_ok=True)
...
for path in image_paths:
    ...
    cv2.imwrite(f"debug_all_good_calibration/{name}", debug)
...
print("\nSaved charuco_calibration_result_best_diverse.npz")